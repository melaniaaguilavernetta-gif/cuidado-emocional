  ...
  return (
    <section id="sobre-mí" className="pt-20 pb-8 bg-gradient-to-b from-white to-emerald-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl text-emerald-800 mb-4">
          Un método probado, adaptado a ti
        </h2>
        <p className="text-lg text-gray-700 mb-10 max-w-3xl">
          Cada persona es única, y por eso mi forma de trabajar también lo es. Integro dos enfoques
          terapéuticos de eficacia demostrada para ofrecerte el mejor acompañamiento posible.
        </p>

        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          <div className="space-y-6">
            <div className="bg-emerald-50 p-6 rounded-xl border-l-4 border-emerald-600">
              <h3 className="text-emerald-800 mb-2">Terapia Cognitivo-Conductual (TCC)</h3>
              <p className="text-gray-700">
                ...
                La TCC es el enfoque con mayor respaldo científico para tratar ansiedad, depresión, estrés y problemas de autoestima.
              </p>
            </div>
            <div className="bg-teal-50 p-6 rounded-xl border-l-4 border-teal-600">
              <h3 className="text-teal-800 mb-2">Programación Neurolingüística (PNL)</h3>
              <p className="text-gray-700">
