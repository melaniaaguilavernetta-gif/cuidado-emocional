...
import { ArticleEclipseEmocional } from './ArticleEclipseEmocional'; // <-- 1. Importamos el nuevo artículo
...
export default function App() {
  ...
  if (path === '/eclipse-emocional') {
    return <ArticleEclipseEmocional />;
  }
        ...
        <section id="blog" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto space-y-6"> 
              ...
              {/* ARTÍCULO 9: Eclipse Emocional (NUEVO DESTACADO) */}
              <a href="/eclipse-emocional" className="block bg-emerald-50 rounded-2xl p-8 border-l-4 border-emerald-600 shadow-sm hover:shadow-lg transition-all duration-300">
              ...
              {/* ARTÍCULO 8: Somatización (Pasó a gris) */}
